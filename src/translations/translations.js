export const translations = {
  es: {
    ...
    contact: {
      title: 'Hablemos',
      description: 'Estoy abierto a nuevas oportunidades y colaboraciones. Si tienes un proyecto en mente o quieres conectar, no dudes en escribirme.',
      name: 'Tu Nombre',
      email: 'Tu Email',
      message: 'Tu Mensaje',
  ...
  en: {
    ...
    contact: {
      title: "Let's Talk",
      description: 'I am open to new opportunities and collaborations. If you have a project in mind or want to connect, feel free to reach out.',
      name: 'Your Name',
      email: 'Your Email',
