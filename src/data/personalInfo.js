...
export const personalInfo = {
  ...
  description:
    "Dynamic and results-driven technical consultant with over 5 years of experience delivering innovative IT solutions in the government and financial sectors. Proven expertise in systems architecture, software development, and project management, complemented by a strong foundation in software engineering with proficiency in React and React Native. Committed to fostering team collaboration and adapting to evolving project needs while consistently driving continuous improvement initiatives.",
...
export const projects = [
  {
    ...
    description:
      "Complete web application for Diners Club card management. Responsive interface developed with React and Spring Boot, integrating internal APIs and external services.",
    image: IMG7,
  ...
  },
  {
    title: "ChatAnalizer",
    description:
      'ChatAnalizer is a privacy-first "Relationship Wrapped" platform built with React and FastAPI that transforms WhatsApp chat histories into deep, AI-powered analytics and cinematic visual stories.',
    image: IMG8,
  ...
  },
  {
    title: "Fitzo",
    description:
      "The app your members will love. Give your gym the app that controls capacity, routines, gamifies the experience, and retains members month after month.",
    image: IMG9,
  ...
  },
  {
    ...
    description:
      "Mobile application for managing Diners Club credit card benefits and rewards. Complete development with React Native, Firebase integration, and analytics tools.",
    image: IMG5,
    tags: ["React Native", "Firebase", "AppsFlyer"],
    liveUrl:
      "https://play.google.com/store/apps/details?id=com.appmundosocios&hl=es_EC",
    codeUrl: null,
    privateRepo: true,
  },
  {
    ...
    description:
      "Official Diners Club mobile application for card and benefits management. Developed with React Native and modern mobile development technologies.",
    image: IMG6,
    tags: ["React Native", "Firebase", "Redux"],
    liveUrl:
      "https://play.google.com/store/apps/details?id=com.blu.de.diners.club&hl=es_EC",
    codeUrl: null,
    privateRepo: true,
  },

  {
    title: "My Dormitory",
    description:
      "Management system for student residences. Mobile application developed with React Native to facilitate university dormitory administration.",
    image: IMG3,
    tags: ["React Native", "Firebase", "Mobile"],
    liveUrl:
      "https://drive.google.com/file/d/1zH8YT7ghaoreTfiLROg8bJQEbIIHV6TL/view?usp=share_link",
...
export const experience = [
  ...
  },
  {
    ...
    location: "Remote",
    description:
      "Developed diverse SaaS products, adapting quickly to different codebases and frameworks. Collaborated on mobile architecture logic for iOS and Android, ensuring consistency across platforms.",
  },
  {
    type: "education",
    date: "06/2023",
    ...
    location: "Russia",
    description:
      "Relevant Coursework: Algorithms, Data Structures, Object-Oriented Programming (Java/JavaScript), System Architecture.",
  },
];
